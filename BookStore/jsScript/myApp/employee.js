...
app.controller('EployeeController', function PostController($scope, $http, AuthorStoreFactory) {
});


//app.controller("EployeeController", ['$scope', '$http',
//    function($scope, $http)  
//    {  
...
//app.controller("DeleteController", ['$scope', '$http', '$routeParams', '$location',  
...
//app.controller("EditController", ['$scope', '$filter', '$http', '$routeParams', '$location',  
